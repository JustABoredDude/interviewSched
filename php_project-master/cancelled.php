...
$status_filter = $_GET['status'] ?? 'cancelled'; // Default to cancelled
    ...
    <div class="container">
        ...
        <section class="filters">
            ...
            <div class="status-filters">
                <select name="status" id="status" onchange="window.location.href='cancelled.php?status=' + this.value + '&department=<?= $selected_department ?>&sort=<?= $sort_order ?>'">
