...
$interviews = getInterviews($conn, $selected_department, 'cancelled'); // Only cancelled interviews
?>
...
<head>
    ...
    <title>Cancelled Interviews</title>
...
<body>
    <div class="container">
        ...
        <section class="filters">
            <form method="GET" action="cancelled.php" class="department-filter">
            ...
            <div class="status-filters">
                ...
                <a href="cancelled.php" class="active">Cancelled</a>
                <a href="rescheduled.php">Rescheduled</a>
            </div>
        </section>

        <h2>Cancelled Interviews</h2>
        ...
        <?php else: ?>
            <p>No cancelled interviews found.</p>
        <?php endif; ?>
    </div>
